...
export function CartaoKpi({ label, value, detail, tone = "blue", icon, trend }: { label: string; value: string; detail: string; tone?: TomKpi; icon: ReactNode; trend?: string }) {
  const styles: Record<TomKpi, string> = { blue: "text-primary border-primary/25", green: "text-[#6bd188] border-[#5bbd75]/30", amber: "text-[#f4cc64] border-[#f1c348]/30", red: "text-[#ed8c90] border-[#e77b80]/30", violet: "text-[#b397ff] border-[#8d6be8]/30" };
...
export function AcaoRapida({ icon, label, detail, color = "blue", onClick }: { icon: ReactNode; label: string; detail: string; color?: "blue" | "green" | "amber" | "violet"; onClick: () => void }) {
  const colors = { blue: "text-primary border-primary/25", green: "text-[#6bd188] border-[#5bbd75]/30", amber: "text-[#f4cc64] border-[#f1c348]/30", violet: "text-[#b397ff] border-[#8d6be8]/30" };
