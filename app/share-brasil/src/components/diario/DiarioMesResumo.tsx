...
export default function DiarioMesResumo({ diario, lancamentos, onEdit, onToggleClosed }: { diario: DiarioMes; lancamentos: DiarioLancamento[]; onEdit: () => void; onToggleClosed: () => void }) {
