...
export function BarraSuperior({ ambiente, podeAcessarGestor, tema, aoTrocarAmbiente, aoAlternarTema, aoAbrirMenu, aoAbrirPerfil }: { ambiente: Ambiente; podeAcessarGestor: boolean; tema: Tema; aoTrocarAmbiente: (ambiente: Ambiente) => void; aoAlternarTema: () => void; aoAbrirMenu: () => void; aoAbrirPerfil: () => void }) {
