...
export function vincularAeronaveSocioShare(socioId: string, payload: { aeronave_id: string; percentual_sociedade: number }) { return colaboradorRequest<Record<string, any>>(`/api/sharebrasil/socios/${socioId}/aeronaves`, { method: "POST", body: JSON.stringify(payload) }); }
