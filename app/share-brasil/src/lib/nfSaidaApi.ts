...
export function atualizarReciboSaida(id: string, payload: Record<string, unknown>) { return request<{ recibo: NotaOuReciboSaidaRow }>(`/api/financeiro/recibos-saida/${encodeURIComponent(id)}`, { method: "PATCH", body: JSON.stringify(payload) }); }
