...
type Formulario = { descricao: string; valor_total: string; data_emissao: string; data_vencimento: string; categoria_id: string; categoria_nome: string; grupo_categoria: string; fluxo: string; status: string; forma_pagamento: string; conta_bancaria: string; fornecedor_nome: string; observacoes: string };

const hoje = () => new Date().toISOString().slice(0, 10);
const inicial: Formulario = { descricao: "", valor_total: "", data_emissao: hoje(), data_vencimento: "", categoria_id: "", categoria_nome: "", grupo_categoria: "DESPESAS EMPRESA", fluxo: "SAIDA", status: "pendente", forma_pagamento: "", conta_bancaria: "", fornecedor_nome: "", observacoes: "" };
