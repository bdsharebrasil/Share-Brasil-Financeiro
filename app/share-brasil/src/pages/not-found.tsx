  ...
  return (
    <div className="flex min-h-[70dvh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <button type="button" onClick={() => navigate("/")} data-testid="link-back-dashboard" className="mx-auto mt-6 flex w-fit items-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-xs font-bold text-primary-foreground transition-transform hover:-translate-y-0.5">
