...
export default function EmissaoRecibo({ aoVoltar }: { aoVoltar: () => void }) {
  ...
  const rateioPagamentoAtivo = form.tipo === "recibo_pagamento" && form.pagador_tipo === "cotista" && form.rateado;
  ...
  const mostrarMetadadosPagamento = form.tipo === "recibo_pagamento" && form.pagador_tipo === "cotista";
  ...
  const categoriaValida = form.tipo !== "recibo_colaborador" || Boolean(
  ...
  const emitir = async () => {
    ...
    try {
      const payload: CriarReciboPayload = {
        ...
        pagador_tipo: form.tipo === "recibo_pagamento" ? form.pagador_tipo : "share",
        pagador_cotista_id: form.tipo === "recibo_pagamento" && form.pagador_tipo === "cotista" ? form.pagador_cotista_id : null,
      ...
      {abaAtiva === "emissao" && <section className="overflow-hidden rounded-sm border border-border bg-card/60 shadow-lg">
        ...
        {form.tipo && <div className="border-t border-border px-5 py-5">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {form.tipo === "recibo_pagamento" && form.pagador_tipo === "cotista" && <div className="md:col-span-2 rounded-xl border border-primary/25 bg-primary/[.05] p-4">
